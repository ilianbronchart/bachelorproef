...
async def glasses_recordings(request: Request, response: Response):
    ...
    if context.glasses_connected:
        ...
        return templates.TemplateResponse("components/failed-connection.jinja", context, headers=response.headers, status_code=503)
...
async def download_recording(request: Request, response: Response, recording_id: str):
