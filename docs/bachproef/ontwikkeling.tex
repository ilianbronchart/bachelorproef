...
Het probleem werd opgelost met een semi-automatische labeling-tool. Daarbij hoeft men enkel in minder dan tien frames per object te klikken. De tool volgt vervolgens elk object automatisch doorheen de hele opname.
...
\begin{itemize}
    ...
    \item \textbf{Opslag:} Niet gekend % TODO: mss opzoeken
\end{itemize}
...
Niet enkel het aantal cores is bepalend, maar ook de hoeveelheid en snelheid van het toegewijde geheugen op de GPU (VRAM).
...
% TODO voeg analyse toe van verschil CPU en GPU?
...
% TODO: veranderingen in AsyncVideoLoader ook beschrijven?
...
% TODO: Belang van zelfde video decoder overal te gebruiken! (enkel ffmpeg)
...
Zoals men kan zien bevat elke regel van het bestand de volgende metadata, waarvan de uitleg afkomstig is van de Tobii Glasses 3 Developer Guide \autocite{Tobii2023}:
\begin{itemize}
...
Gegeven het totaal aantal frames in de video, de lijst van \texttt{GazePoint}-objecten (gesorteerd op timestamp), 
