...
Zoals men kan zien bevat elke regel van het bestand de volgende metadata, waarvan de uitleg afkomstig is van de Tobii Glasses 3 Developer Guide \autocite{tobii_developer_guide}:
\begin{itemize}
