...
% TODO: Als er tijd is probleem met belichting toevoegen
...
Merk op dat het mogelijk is om om het even welke opname te selecteren als kalibra\-tie-opname, waardoor ook evaluatieopnames kunnen worden gebruikt!
...
De instructies voor het installeren en configureren van de applicatie zijn te uitvoerig beschreven in de README\footnote{\url{https://github.com/ilianbronchart/bachelorproef/blob/master/README.md}} file van de Git repository.
