...
Een belangrijke overweging bij het implementeren van de applicatie in het Zorglab zijn de hardwarevereisten.
...
\paragraph{VRAM: Analyse van de vereisten}
...
Via de \texttt{torch.profiler} module werd de geheugengebruik van elk model gemeten tijdens het laden van de parameters.
De resultaten zijn als volgt:
\begin{itemize}
    \item \textbf{sam2.1_hiera_large.pt}: 1000.91 Mb
    \item \textbf{sam2.1_hiera_base_plus.pt}: 450.47 Mb
    \item \textbf{sam2.1_hiera_small.pt}: 315.29 Mb
    \item \textbf{sam2.1_hiera_tiny.pt}: 288.71 Mb
\end{itemize}
...
\subsubsection{Bugfix in de SAM2-bibliotheek}
