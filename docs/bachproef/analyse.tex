...
\paragraph{3. Berekenen van Confusion Matrix Metrieken}
...
\begin{figure}[H]
  ...
  \caption[
    Staafdiagram van het aantal vals-positieven per klasse voor het beste model.
  ]{\label{fig:false-positives-per-class}
...
Zoals men kan zien, zijn alle vals-positieven in de werkelijkheid toch correcte detecties, maar werden ze niet opgenomen in de grondwaarheidsdataset.
...
\begin{figure}[H]
    ...
    \caption[
    Voorbeelden van vals-positieven voor de klasse `naaldcontainer' van het beste model
    ]{\label{fig:fp-examples-naaldcontainer}
...
Een consistent resultaat is dat de meeste klassen een dunne, lange staart vertonen in de vioolplots voor de FN's. 
